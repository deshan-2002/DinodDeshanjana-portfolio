      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <motion.a
            ...
            className="flex items-center justify-center gap-2 sm:gap-3 w-full sm:w-auto px-6 py-4 md:px-8 md:py-5 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-medium sm:font-semibold shadow-lg hover:shadow-brand-500/25 transition-all mb-10 md:mb-12 text-sm sm:text-base md:text-lg"
          >
